...
internal interface IAssemblyInspector
{
    ...
    Task<TypeDetailResult> GetTypeDetailAsync(string packageId, string version, string? tfm, string? assemblyName, string typeName, bool includeInherited, CancellationToken ct);
